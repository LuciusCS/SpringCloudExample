...
public class MoeMallController {
    ...
    public Map<String, Object> getHomeProducts() {
        ...
        // Use local images from /prizes
        list.add(createProduct("1", "鲷鱼烧章鱼烧", "5.88", "/prizes/prize1.jpg", "糕糕扭蛋铺", "2.5k"));
        list.add(createProduct("2", "三张披萨 x 福利直 go", "0.52", "/prizes/prize2.jpg", "沦为雪", "1.2w"));
        list.add(createProduct("3", "小熊娃娃", "2.00", "/prizes/prize3.jpg", "白雪小店", "629"));
        list.add(createProduct("4", "帕尼尼 x 像素椰子姐妹头", "6.60", "/prizes/prize4.jpg", "帕尼尼直购", "2.4w"));
        list.add(createProduct("5", "可爱萌妹头像", "9.99", "/prizes/prize1.jpg", "萌萌哒", "1.5k"));
    ...
    public Map<String, Object> getUserInfo() {
        ...
        data.put("avatar", "/prizes/prize1.jpg"); // Placeholder
        data.put("balance", "0");
        data.put("level", "V1");
    ...
    public Map<String, Object> getHouseItems() {
        ...
        items1.add(createHouseItem("101", "小楠熊2号机", "/prizes/prize1.jpg", false));
        items1.add(createHouseItem("102", "小黑熊", "/prizes/prize2.jpg", false));
        items1.add(createHouseItem("103", "限定款", "/prizes/prize3.jpg", true));
        ...
        items2.add(createHouseItem("201", "粉色星球冬日限定", "/prizes/prize4.jpg", false));
    ...
    public Map<String, Object> getProductDetail(@PathVariable String id) {
        ...
        data.put("imageUrl", "/prizes/prize1.jpg"); // Use one of the images
